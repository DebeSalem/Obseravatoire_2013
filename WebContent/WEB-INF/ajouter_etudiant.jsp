...
<body>
	...
	<form action = "http://localhost:8080/test/Verif" method = "POST">
		<div class = "collection">
			Nom <input type = "text" name = "nom"> <br>
			Prenom <input type = "text" name = "prenom"> <br>
			Date de Naissance : Jour : <input type = "text" maxvalue = "2" name = "jourNaissance"> Mois : <input type = "text" name = "moisNaissance"> Année : <input type = "text" name = "anneeNaissance"> <br>
			...
			<br>
			<br>
			<input type = "checkbox" name = "contEtud"> L'étudiant a-t-il continué ses études ? <br>
		...
		Date du début d'études <input type = "text" name = "date_debt_cont"> <br>  <br>
		<input type = "checkbox" name = "contEtud"> L'étudiant a-t-il été employé ? <br>
			<hr width = "50%" align = "left"> 
												Nom de l'entreprise : <input type = "text" name = "entre_emploi"> <br>
									Votre poste : <input type = "text" name = "poste_entre"> <br>
									Pays : <input type = "text" name = "pays_entre"> <br>
									Ville: <input type = "text" name = "vill_entr"> <br>
									Type de service : <input type = "text" name = "type_serv_entreprise"> <br>

									Adresse : <input type = "text" name = "adress_entreprise"> <br>
									Date du début d'emploi: <input type = "text" name = "date_debut_emploi"> <br>
